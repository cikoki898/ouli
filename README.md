...
ou­li is a high-performance HTTP/WebSocket record-replay proxy built in Rust. It employs principles from TigerBeetle, making it a 10× faster and memory-safe alternative to traditional test servers. Whether you’re testing APIs or managing connections, ouli provides a smooth experience for users who need reliable data flow.
...
ou­li comes with various features to enhance your testing experience:
...
2. **Start Recording**: Simply trigger the record option from the application’s UI. ouli will start capturing traffic.
...
ou­li is built with modern principles that focus on performance and reliability. The inspiration from TigerBeetle principles enhances our work, allowing us to provide a robust tool for developers and testers alike.
